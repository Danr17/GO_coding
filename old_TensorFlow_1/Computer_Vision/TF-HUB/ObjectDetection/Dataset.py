...
class Dataset:
    ...
    def _create_iterator(self):
        self._pl_image_file_paths = tf.placeholder(tf.string, (None), name='pl_image_path')
        ...
        self._iterator_initilizer = iterator.make_initializer(dataset, name='initializer')
    ...
    def initialize_iterator(self, sess, file_paths):
        ...
        sess.run(self._iterator_initilizer, feed_dict=feed_dict)